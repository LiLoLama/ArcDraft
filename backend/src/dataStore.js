    ...
    sections: [
      {
        ...
        title: 'Hero',
        type: 'hero',
        contentStructure: { title: 'ArcDraft Consulting', subtitle: 'Wachstum mit AI-gestützten Prozessen' },
      },
      {
        id: nanoid(),
        title: 'Scope',
        type: 'text',
        contentStructure: { text: 'Wir unterstützen {{client_name}} bei {{project_title}}.' },
      },
      {
        id: nanoid(),
        title: 'Pricing',
        type: 'pricing',
        contentStructure: { rows: [{ title: 'Retainer', price: '€12.000', description: '3 Monate' }] },
      },
    ],
    variablesSchema: [
      { key: 'client_name', label: 'Client Name', type: 'string' },
      { key: 'project_title', label: 'Project Title', type: 'string' },
    ],
    createdAt: now(),
    updatedAt: now(),
  },
